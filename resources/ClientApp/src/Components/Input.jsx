...
const Input = ({ divClass, inputName, inputType, inputClass, inputplaceholder, inputValue,
    ...
    buttonOnClick, labelClass, labelText, span2Class, spanClassError, div2Class, readOnly = false, min = 0, max = "", maxLength = 500}) => {
            ...
            return (
                <div>
                    <div className={divClass}>
                        ...
                        <input autoComplete={autoComplete} name={inputName} type={inputType} min={min} max={max} className={inputClass} placeholder={inputplaceholder} value={inputValue} onChange={inputOnchange} />
                    </div>
                    <span className={spanClass}>{spanError}</span>
                </div>
            )
                ...
                if (divClassSpanType === 1) {
                    return (
                        <div>
                            <div className={divClass}>
                                <span className={divClassSpan}><i className={divClassSpanI}></i></span>
                                <input autoComplete={autoComplete} name={inputName} maxLength={maxLength} type={inputType} className={inputClass} placeholder={inputplaceholder} value={inputValue} onChange={inputOnchange} />
                            </div>
                            <span className={spanClass}>{spanError}</span>
                        </div>
                    )
